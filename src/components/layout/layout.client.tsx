...
import { Sidebar, SidebarProps } from "./sidebar.client";
import { useLayout } from "./context";
import { LogoProps } from "./logo.server";
...
export const Layout = ({
    ...
    const sidebarProps: SidebarProps = { isOpen: isSidebarOpen, close: closeSidebar, logo, menu, menuItems, menuWithSearch, className: className?.sidebar }
