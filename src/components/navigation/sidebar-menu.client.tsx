...
import * as Root from '../../slots/sidebar-menu/root.slot';
import * as Search from '../../slots/sidebar-menu/search.slot';
import * as List from '../../slots/sidebar-menu/list.slot';
import * as Divider from '../../slots/sidebar-menu/divider.slot';
import * as Group from '../../slots/sidebar-menu/group-client.slot';
import * as Button from '../../slots/sidebar-menu/button.slot';
