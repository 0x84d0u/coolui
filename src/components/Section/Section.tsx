...
import * as Root from '@components/Section/root.slot';
import * as Header from '@components/Section/header.slot';
import * as Content from '@components/Section/content.slot';
import * as Footer from '@components/Section/footer.slot';
